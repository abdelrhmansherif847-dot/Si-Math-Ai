...
const NEEDS_TS = /scope-guardrail|zero-personality|edge-security|shared-cors|exam-strategy|verification-v0|verification-core-parity|entitlement-gate|v3-shadow-routing|meta-graph|meta-isolation/;
