...
| Migrations | **89 files** in `supabase/migrations/`, **149 applied** in the database (Mock Exam v2 M3 `question_spine` applied 2026-08-24 as version `20260824005242`) |
| Static site | 46 root `*.html` pages on Vercel |
| CI | `node tests/run-all.mjs` — **52 checks** |
