...
| Static site | **52** root `*.html` pages on Vercel (measured 2026-09-01, after `teacher-exams.html`). **`teacher-exams.html` is in the repo and NOT deployed** — nothing reaches a student or a teacher until this branch merges |
| CI | `node tests/run-all.mjs` — **63 checks** (measured 2026-09-01, after `teacher-exam-ui`) |
