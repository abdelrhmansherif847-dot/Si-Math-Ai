...
// from it. ai-tutor still has its own inline copy for now — migrating a 205 KB
// production function is a deliberate change of its own, and
// tests/edge-security.test.mjs asserts the two agree.
//
