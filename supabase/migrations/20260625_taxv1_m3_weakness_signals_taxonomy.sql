...
ALTER TABLE public.weakness_signals DROP CONSTRAINT IF EXISTS weakness_signals_taxver_chk;
ALTER TABLE public.weakness_signals ADD  CONSTRAINT weakness_signals_taxver_chk
